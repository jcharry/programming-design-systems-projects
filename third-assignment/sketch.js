...
//var poly = r.polygon(cw / 2, ch / 2).fill(false),
    //angle = 360 / numPoints,
    //radius = 200;

//for (var i = 0; i < numPoints; i++) {
    //var radiusOffset = Math.sin(i * r.radians(angle) * 10) * 20;
    //var x = Math.cos(i * r.radians(angle)) * (radius + radiusOffset);
    //var y = Math.sin(i * r.radians(angle)) * (radius + radiusOffset);
