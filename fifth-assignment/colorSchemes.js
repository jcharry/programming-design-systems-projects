...
let colorSchemes = function(){
    ...
    let tetradic = function(base, numColors) {
        ...
        for (var i = 0; i < numColors / 4; i++) {
            ...
            colors.push(new Rune.Color('hsv', base, r.random(50, 70), r.random(50, 100)));
            colors.push(new Rune.Color('hsv', base + 90, r.random(50, 70), r.random(50, 100)));
            colors.push(new Rune.Color('hsv', base + 180, r.random(50, 70), r.random(50, 100)));
            colors.push(new Rune.Color('hsv', base + 270, r.random(50, 70), r.random(50, 100)));
        }
        return colors;
    };
